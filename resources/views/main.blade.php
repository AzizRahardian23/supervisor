...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" href="../template/assets/img/brand/wkgarut.png" type="image/png">
  <!-- Fonts -->
    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="../template/assets/img/brand/wkgarut.png" class="navbar-brand-img" alt="...">
        </a>
      </div>
      ...
      @if(Auth::user()->jabatan==('kurikulum'));    
            <li class="nav-item">
      ...
      @if(Auth::user()->jabatan==('guru'));
            <li class="nav-item">
              <a class="nav-link" href="/rpp">
                <i class="ni ni-pin-3 text-primary"></i>
                <span class="nav-link-text">RPP</span>
              </a>
            </li>
     @endif
     @if(Auth::user()->jabatan==('admin'));
     ...
     @if(Auth::user()->jabatan==('kurikulum '));
             <li class="nav-item"> 
              <a class="nav-link" href="/nilai">
                <i class="ni ni-pin-3 text-primary"></i>
                <span class="nav-link-text">Nilai RPP</span>
              </a>
            </li>
      @endif
      ...
      @endif
      @if(Auth::user()->jabatan==('kepalasekolah'));
            <li class="nav-item">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
            <li class="nav-item dropdown">
              <div></div>
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> {{Auth::user()->name}}
